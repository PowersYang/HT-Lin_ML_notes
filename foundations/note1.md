...
>三岁小孩辨识树不是通过特定的定义，而是去通过大量的经验去辨识。想要让机器学习做一件事情，就是让及其自己去分析事情，自己去探寻规律，不是让人按照自己的经验写出特定的定义和规则。

>机器学习应用的方向?
>
> - 有些系统人们不知道怎么写出它的规则（人类探索火星的例子）
> - 有些系统人们不容易写出规则。例如视觉、声音的辨识。
> - 有些应用是人想都没有想过的。例如股市的交易，比如在10秒20秒的时间内就让机器做出决定要不要买某个股票。人可能不会再这么短的时间里做出选择。
> - 针对每个使用者有个性的定制化，个性化服务每个人。人不可能针对大量客户制定个性化服务。也就是说教会电脑钓会的方法。



什么情况下会使用机器学习来解决问题呢？其实，目前机器学习的应用非常广泛，基本上任何场合都能够看到它的身影。其应用场合大致可归纳为三个条件：

- 事物本身存在某种潜在规律，这些规律是可以学习的
- 某些问题难以使用普通编程解决，不知道怎么写下它的规则
- 有大量的数据样本可供使用
...
> - 食。从大量数据可以预测某个人吃某家餐厅会不会拉肚子，卫生状况如何。
> - 衣。可以根据衣服的额销量和评价等做推荐系统，可以告诉顾客怎么样搭配最好看。
> - 住。想办法预测建好的房子的能源消耗问题——节能减碳。
> - 行。自动驾驶，自动辨识交通符号。
> - 教育。线上教育系统可以从学生答题的过程可以发现学生会哪些不回哪些，进而了解学生的学习状况，对于一个新题目可以预测该学生会不会做以及会的程度。可以判断在某个时间点学生的学习程度怎么样，对于该生题目的难度怎么样，下一次是否应该增加难度。
> - 娱乐。根据用户历史评价实现电影推荐系统，可以根据个人喜好个性化推荐用户喜欢的电影（动作片、爱情片、剧情片...）。
